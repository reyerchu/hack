  ...
  return (
    <div className="relative flex flex-col flex-grow min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-20 w-full">
            ...
            <div className="flex items-center justify-center min-h-screen px-4">
              ...
              <div className="rounded-lg relative bg-white flex flex-col shadow-xl p-6 max-w-md mx-auto z-50">
                ...
                <div className="mb-6 flex flex-col gap-y-3">
                  ...
                  <p className="text-gray-600 text-sm">確定要刪除此掃描類型嗎？此操作無法復原。</p>
                </div>
        ...
        {showNewScanForm ? (
          <div
            className="bg-white rounded-lg shadow-sm p-6 mt-8 border-2"
                          ...
                          {scanData ? (
                            <div
                              ...
                              style={{
                                ...
                                backgroundColor:
                                  getSuccessColor(success) === '#5fde05' ? '#f0fdf4' : '#fef2f2',
                              }}
                            >
