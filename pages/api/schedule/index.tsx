...
function getMockScheduleEvents() {
  return [
    ...
    },
    {
      ...
      endTimestamp: { _seconds: new Date('2025-10-26T19:00:00+08:00').getTime() / 1000 },
    },
    {
      title: '黑客松經驗分享',
      Event: 3,
    ...
    },
    {
      ...
      status: 'confirmed',
      tags: ['黑客松'],
      startDate: new Date('2025-11-01T09:30:00+08:00'),
      endDate: new Date('2025-11-01T11:30:00+08:00'),
      startTimestamp: { _seconds: new Date('2025-11-01T09:30:00+08:00').getTime() / 1000 },
