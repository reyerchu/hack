        ...
        <div className="max-w-[1200px] mx-auto px-8 md:px-12 py-16 md:py-20">
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="mb-6">
                <h3 className="text-[20px] font-semibold mb-4" style={{ color: '#1a3a6e' }}>
                  1.1 基本資格
                </h3>
              ...
              <div className="mb-6">
                ...
                <p className="text-[16px] leading-relaxed text-gray-700 mb-4">若以團隊形式參賽：</p>
                <ul className="list-disc list-inside text-[16px] leading-relaxed text-gray-700 mb-6 space-y-2">
              ...
              <div className="mb-6">
                ...
                <p className="text-[16px] leading-relaxed text-gray-700 mb-4">本人理解且接受：</p>
                <p className="text-[16px] leading-relaxed text-gray-700 mb-3 font-semibold">
                  （一）報名審查與活動調整
                </p>
                <ul className="list-disc list-inside text-[16px] leading-relaxed text-gray-700 mb-4 space-y-2">
            ...
            <section className="mb-12">
              ...
              <div className="mb-6">
                ...
                <p className="text-[16px] leading-relaxed text-gray-700 mb-4">
                  本活動中所提供之題目、資料集、API、工具或其他素材（如有），其智慧財產權均屬原出題單位或提供方所有。本人僅得於本活動期間內，為參賽目的合理使用前述素材。若素材屬第三方授權資源（如開放資料、外部
                  API、SDK 等），本人應依該資源原有之授權條款使用，並於成果之 README
                  檔案或說明文件中清楚標示資源名稱、原授權條款（如 MIT、Apache 2.0、GPL
                  等）及來源網址或出處。
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-[16px] leading-relaxed text-gray-700 mb-3">
                  本人仍授予主辦方、協辦方與贊助方：
                </p>
                <ul className="list-disc list-inside text-[16px] leading-relaxed text-gray-700 mb-6 space-y-2">
                  <li>非專屬、全球、免權利金、不可撤銷之永久使用權</li>
                  <li>
                    使用目的包括：活動展示與評審、教育訓練與案例分享、主辦方自行撰寫之活動成果報告（不包括以參賽者為主要作者之學術論文）、非商業性推廣與行銷
                  </li>
