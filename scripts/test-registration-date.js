...
async function testRegistrationDate() {
  ...
  console.log(`   ${usersWithTimestamp > 0 ? '✅' : '❌'} Users with timestamp: ${usersWithTimestamp}`);
  console.log(`   ${usersWithoutTimestamp === 0 ? '✅' : '❌'} Users without timestamp: ${usersWithoutTimestamp}`);
