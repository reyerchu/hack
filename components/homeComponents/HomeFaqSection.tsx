...
export default function HomeFaqSection() {
  const faqs = [
    ...
    },
    {
      question: '報名需要提供什麼資料？',
      answer:
        '• 個人預報名時，流程簡單，不會要求填寫過多個資。\n• 如果你願意提供完整的履歷與資料，能幫助主辦方更好媒合贊助商、協辦單位的需求（例如人才招募或職缺配對）。\n• 上傳履歷是選填、非強制。',
    },
    {
      question: '報名截止日？',
    ...
    },
    {
      question: '需要自己準備隊伍嗎？',
      answer:
        '不一定，你可以自己組隊報名，也可以先個人報名，主辦方會舉辦工作坊等活動協助媒合，找到志同道合的夥伴。',
    },
    {
      question: '人在國外或無法出席黑客松活動日，可以參加嗎？',
      answer:
        '可以。只要最後組隊的團隊中至少有一位成員會在 11/1 下午現場參加活動即可。如果你一開始是個人報名但人在海外，仍然可以透過線上方式參與工作坊等活動，最後只要找到能現場出席的隊友即可（參考 7 組隊方式）。',
    },
    {
      question: '有什麼獎項？',
      answer:
