  ...
  const faqs = [
    {
      ...
      answer:
        '2025/10/31（五）10:00~22:00 及 11/1（六）9:00~11:30 最後衝刺\n• 地點：政大公企中心 A747\n\n2025/11/1（六）13:30~16:30 Demo Day\n• 地點：政大公企中心 A645',
    },
    {
      question: '活動日程怎麼安排？',
      answer:
    ...
    },
    {
      ...
      answer:
        '可以。只要最後組隊的團隊中至少有一位成員會在 11/1 下午現場參加活動即可。如果您一開始是個人報名但人在海外，仍然可以透過線上方式參與工作坊等活動，最後只要找到能現場出席的隊友即可。',
    },
    {
      question: '有什麼獎項？',
      answer:
    ...
    {
      question: '兩天黑客松活動是否有供餐？',
      answer:
        '有。10/31 10:00~22:00 會供應午餐及晚餐，11/1（六）9:00~16:30 會供應午餐，非用餐時間會有茶點及飲料。餐點茶飲僅提供給有報名入場的黑客、導師、贊助商及工作人員。',
    },
    {
      question: '兩天黑客松活動是否有安排導師在場？',
      answer:
        '有。一天半的衝刺期會安排堅強的導師群在現場，黑客有任何問題都歡迎與導師交流討論。導師群名單將於活動前公布。',
    },
  ];
